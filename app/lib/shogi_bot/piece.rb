...
module ShogiBot
  class Piece
    ...
    SENTE_MOVES = [
      nil,
      [-1], [], [-12, 8], [11, 9, -1, -9, -11], # FU, KY, KE, GI
      [10, 9, 1, -1, -10, -11], [], [], [-11, -10, -9, -1, 1, 9, 10, 11], # KI, KA, HI, OU
      [10, 9, 1, -1, -10, -11], [10, 9, 1, -1, -10, -11], # TO, NY
      [10, 9, 1, -1, -10, -11], [10, 9, 1, -1, -10, -11], # NK, NG
      nil, [-10, -1, 1, 10], [-11, -9, 9, 11] # nil, UM, RY
    ]
    GOTE_MOVES = [
      nil,
      [1], [], [12, -8], [11, 9, 1, -9, -11], # FU, KY, KE, GI
      [11, 10, 1, -1, -9, -10], [], [], [11, 10, 9, 1, -1, -9, -10, -11], # KI, KA, HI, OU
      [11, 10, 1, -1, -9, -10], [11, 10, 1, -1, -9, -10], # TO, NY
      [11, 10, 1, -1, -9, -10], [11, 10, 1, -1, -9, -10], # NK, NG
      nil, [10, 1, -1, -10], [11, 9, -9, -11], [], # nil, UM, RY
    ]
    SENTE_JUMPS = [
      nil,
